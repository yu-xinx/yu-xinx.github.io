...
webpackJsonpL2Dwidget([0], {
	76: function(t, e, i) {
		...
		e.theRealInit = function() {
			...
			var t = n.currCanvas.getBoundingClientRect(),
				...
				$ = -e,
				P = e;
			(y = new a.L2DViewMatrix)
			.setScreenRect(i, r, $, P), y.setMaxScreenRect(l.cDefine.VIEW_LOGICAL_MAX_LEFT, l.cDefine.VIEW_LOGICAL_MAX_RIGHT, l.cDefine.VIEW_LOGICAL_MAX_BOTTOM, l.cDefine.VIEW_LOGICAL_MAX_TOP), S = u.default.mobile() && o.config.mobile.scale || o.config.model.scale, y.adjustScale(0, 0, S);
			var S;
			(m = new a.L2DMatrix44)
			.multScale(1, t.width / t.height), (T = new a.L2DMatrix44)
				.multTranslate(-t.width / 2, -t.height / 2), T.multScale(2 / t.width, -2 / t.height), s.Live2D.setGL(n.currWebGL), n.currWebGL.clearColor(0, 0, 0, 0), v = o.config.model.jsonPath, c.reloadFlg = !0, c.count++, c.changeModel(n.currWebGL, v);
			var v;
			g || (g = !0, function t() {
				! function() {
		...
		(function(t) {
			...
			function o(t) {
				if (!i) {
					...
					var e = new E;
					(e = new E)
					.r = 0, e.g = 0, e.b = 0, e.a = 1, this.CHANNEL_COLORS.push(e), (e = new E)
						.r = 1, e.g = 0, e.b = 0, e.a = 0, this.CHANNEL_COLORS.push(e), (e = new E)
						.r = 0, e.g = 1, e.b = 0, e.a = 0, this.CHANNEL_COLORS.push(e), (e = new E)
						.r = 0, e.g = 0, e.b = 1, e.a = 0, this.CHANNEL_COLORS.push(e);
			...
			o.CHANNEL_COUNT = 4, o.RENDER_TEXTURE_USE_MIPMAP = !1, o.NOT_USED_FRAME = -100, o.prototype._$L7 = function() {
				...
				if (i > 0) {
					...
					for (r = 0; r < this.clipContextList.length; r++) {
						var a = (o = this.clipContextList[r])
							.allClippedDrawRect,
				...
				for (var i = t._$Ri.getModelImpl()
					...
					.getCanvasHeight(), o = i > r ? i : r, n = o, s = o, a = 0, _ = 0, h = e.clippedDrawContextList.length, l = 0; l < h; l++) {
				...
				for (var r = 0, n = 0; n < o.CHANNEL_COUNT; n++) {
					...
					if (0 == s);
						...
						($ = this.clipContextList[r++])
						.layoutChannelNo = n, $.layoutBounds.x = 0, $.layoutBounds.y = 0, $.layoutBounds.width = 1, $.layoutBounds.height = 1
					} else if (2 == s)
						for (var _ = 0; _ < s; _++) {
							var h = 0;
							l = ~~(l = _ % 2);
							($ = this.clipContextList[r++])
							.layoutChannelNo = n, $.layoutBounds.x = .5 * l, $.layoutBounds.y = 0, $.layoutBounds.width = .5, $.layoutBounds.height = 1
						} else if (s <= 4)
							for (_ = 0; _ < s; _++) {
								l = ~~(l = _ % 2), h = ~~(h = _ / 2);
								($ = this.clipContextList[r++])
								.layoutChannelNo = n, $.layoutBounds.x = .5 * l, $.layoutBounds.y = .5 * h, $.layoutBounds.width = .5, $.layoutBounds.height = .5
							} else if (s <= 9)
								for (_ = 0; _ < s; _++) {
									var l;
									l = ~~(l = _ % 3), h = ~~(h = _ / 3);
									var $;
									($ = this.clipContextList[r++])
									.layoutChannelNo = n, $.layoutBounds.x = l / 3, $.layoutBounds.y = h / 3, $.layoutBounds.width = 1 / 3, $.layoutBounds.height = 1 / 3
			...
			X.prototype = new M, X._$As = 32, X._$Gr = !1, X._$NT = null, X._$vS = null, X._$no = null, X._$9r = function(t) {
				...
				return null == t || t._$yL() < e.length ? ((t = X._$9r(2 * e.length))
					.put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)), t
			}, X._$mb = function(t, e) {
				return null == t || t._$yL() < e.length ? ((t = X._$vb(2 * e.length))
					.put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)), t
			}, X._$Hs = function() {
				return X._$Gr
			}, X._$as = function(t) {
			...
			yt.prototype = new M, yt._$9r = function(t) {
				...
				return null == t || t._$yL() < e.length ? ((t = yt._$9r(2 * e.length))
					.put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)), t
			}, yt._$mb = function(t, e) {
				return null == t || t._$yL() < e.length ? ((t = yt._$vb(2 * e.length))
					.put(e), t._$oT(0)) : (t.clear(), t.put(e), t._$oT(0)), t
			}, yt._$Hs = function() {
				return this._$Gr
			}, yt._$as = function(t) {
				...
				if (!(n < .01 && null == this.clipBufPre_clipContextMask)) {
					...
					if (null != this.clipBufPre_clipContextMask) {
						...
						var f = this.getClipBufPre_clipContextMask()
							.layoutBounds;
						...
						_.useProgram(this.shaderProgramOff), this._$vS = mt(_, this._$vS, r), this._$no = Tt(_, this._$no, i), _.enableVertexAttribArray(this.a_position_Loc_Off), _.vertexAttribPointer(this.a_position_Loc_Off, 2, _.FLOAT, !1, 0, 0), this._$NT = mt(_, this._$NT, o), _.activeTexture(_.TEXTURE1), _.bindTexture(_.TEXTURE_2D, this.textures[t]), _.uniform1i(this.s_texture0_Loc_Off, 1), _.enableVertexAttribArray(this.a_texCoord_Loc_Off), _.vertexAttribPointer(this.a_texCoord_Loc_Off, 2, _.FLOAT, !1, 0, 0), _.uniformMatrix4fv(this.u_clipMatrix_Loc_Off, !1, this.getClipBufPre_clipContextDraw()
							.matrixForDraw), _.uniformMatrix4fv(this.u_matrix_Loc_Off, !1, this.matrix4x4), _.activeTexture(_.TEXTURE2), _.bindTexture(_.TEXTURE_2D, at.fTexture[this.glno]), _.uniform1i(this.s_texture1_Loc_Off, 2);
						p = this.getClipBufPre_clipContextDraw()
							.layoutChannelNo, c = this.getChannelFlagAsColor(p);
			...
			Mt._$W2 = 0, Mt.SYSTEM_INFO = null, Mt.USER_AGENT = navigator.userAgent, Mt.isIPhone = function() {
				...
				function e(t, e) {
					for (var i = t.substring(e)
						.split(/[ _,;\.]/), r = 0, o = 0; o <= 2 && !isNaN(i[o]); o++) {
						var n = parseInt(i[o]);
						if (n < 0 || n > 999) {
	...
	78: function(t, e, i) {
		...
		p.load = function(t) {
			for (var e = new p, i = y.getPlatformManager()
				.jsonParseFromBytes(t)
				.physics_hair, o = i.length, n = 0; n < o; n++) {
				var s = i[n],
					a = new r.PhysicsHair,
					_ = s.setup,
		...
		c.load = function(t) {
			for (var e = new c, i = y.getPlatformManager()
				.jsonParseFromBytes(t)
				.parts_visible, r = i.length, o = 0; o < r; o++) {
	...
	79: function(t, e, i) {
		...
		e.cDefine = {
			...
			MOTION_GROUP_TAP_DIAO: "tap_diao",
			MOTION_GROUP_TAP_HAND: "tap_hand",
			MOTION_GROUP_TAP_upperbody: "tap_upperbody",
	...
	82: function(t, e, i) {
		...
		t.exports = {
			createDialogElement: function(t) {
				...
				.className = "live2d-widget-dialog-container", n.style.transform = "scale(" + r.config.display.width / 250 + ")", (s = document.createElement("div"))
					.className = "live2d-widget-dialog", n.appendChild(s), t.appendChild(n), o.L2Dwidget.emit("create-dialog", n), r.config.dialog.hitokoto && $()
			},
			displayDialog: _,
			hiddenDialog: h,
			alertText: l,
